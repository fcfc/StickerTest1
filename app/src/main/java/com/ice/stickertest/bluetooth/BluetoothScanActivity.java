...
public class BluetoothScanActivity extends ListActivity {
    ...
    private static final long SCAN_PERIOD_10SEC = 10000;    // stop scan after 10 seconds
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.blutooth_main, menu);
        if (!mScanning) {
    ...
    // Adapter for storing devices found through scanning.
